...
const LoginPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen items-center bg-gradient-to-b from-[#6970F3] to-[#3D418D] -mx-[1.5rem] relative">
      <LoopyIconSection />
      ...
      <div
        className="absolute bottom-[clamp(1px,calc((100vh-820px)*0.5+32px),80px)] 
        left-0 right-0 w-full px-[1.625rem] max-w-[393px] mx-auto
      ...
      >
        ...
        <div className="mt-[1.5rem] mb-[0.5rem] relative z-[30]">
          <CommonButton
            text="로그인"
        ...
        <div
          className="mb-[2.5rem] relative z-[40]"
          style={{
            pointerEvents: "auto",
